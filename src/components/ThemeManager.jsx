...
const ThemeManager = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full transition-all duration-[2000ms] ease-in-out -z-10">
      <div
        className="absolute inset-0 bg-center bg-cover transition-all duration-[2000ms] ease-in-out"
        style={{
